<?php
    ...
    if(isset($_GET['id_penjual'])){
        ...
        $result_produk = mysqli_query($con, "SELECT * FROM produk_jualcepat INNER JOIN produk ON produk_jualcepat.id_produk = produk.id_produk WHERE produk_jualcepat.id_penjual = '$id_penjual' AND produk_jualcepat.berakhir > CURDATE()");

        $jml_produk = mysqli_query($con, "SELECT * FROM produk WHERE id_login = '$id_penjual'");
    }else{
...
<div class="container d-flex flex-column px-0">
    ...
    <!-- nama penjual -->
    <div class="head d-flex justify-content-start align-items-center px-3 pb-3" style="background-color: darkcyan;">
        <div>
        ...
        <div class="d-flex flex-column w-75">
            ...
            <div class="rating d-flex flex-row align-items-center">
                ...
                ?>
                <span class="text-white" style="font-size: small; margin-left:5px;">(<?= mysqli_num_rows($jml_produk); ?> Produk)</span>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center bg-white">
        <a href="lihat_toko.php?id_penjual=<?= $_GET['id_penjual'];?>" class="py-2 px-3 text-center" style="border-top: 2px solid darkcyan; width:33%; background:darkcyan; color: white;">Semua</a>
        
        <a href="lihat_toko_diskon.php?id_penjual=<?= $_GET['id_penjual'];?>" class="py-2 px-3 text-center" style="border-top: 2px solid darkcyan; width: 33%; color:white; background:darkcyan;">Diskon</a>

        <div class="py-2 px-3 text-center" style="border-top: 2px solid darkcyan; width: 34%; color: darkcyan;">Jual Cepat</div>
    </div>
    ...
    <div class="produkrekomendasi bg-white container pt-3" style="padding-bottom: 20px;">
        <div class="d-flex flex-row justify-content-center">
            ...
            <div class="cart-produk-jualcepat d-block pb-2" style="width: 160px;">
                ...
                <!-- harga -->
                <b class="harga m-0" style="color: darkcyan;"><?= rupiah($produk['harga_baru']); ?></b>
                </a>
                <!-- mulai -->
                <div class="rating d-flex-column justify-content-center align-items-center">
                    <span class="d-block text-secondary" style="font-size: small; line-height:15px;"><?= "Mulai: ".$produk['mulai']; ?></span>
                    <span class="d-block text-secondary" style="font-size: small; line-height:15px;"><?= "Berakhir: ".$produk['berakhir']; ?></span>
                </div>
