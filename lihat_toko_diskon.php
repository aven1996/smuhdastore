<?php
    ...
    if(isset($_GET['id_penjual'])){
        ...
        $result_produk = mysqli_query($con, "SELECT * FROM produk_diskon INNER JOIN produk ON produk_diskon.id_produk = produk.id_produk WHERE produk_diskon.id_penjual = '$id_penjual'");
...
<div class="container d-flex flex-column px-0">
    ...
    <div class="d-flex justify-content-center align-items-center bg-white">
        ...
        <div class="py-2 px-3 text-center" style="border-top: 2px solid darkcyan; width: 33%; color:darkcyan;">Diskon</div>
